...
static size_t strtotallen(const char *str, const char *find, size_t len, size_t seglen) {
    char *ptr;
    size_t found;
...
static char *strset(const char *str, const char *find, const char *replace, const size_t *lentable) {
    size_t i;
    size_t len;
    char *new;
    char *ptr;
